...
contract CanncoinCash is owned {
    ...
    function _transfer(
        ...
        uint _value) 
    internal {
        // Prevent transfer to invalide address 
    ...
    /**
     * Send `_value` tokens from your account to `_to` 
     *
    ...
    function transferFrom(
        ...
        uint256 _value) 
    public returns (bool success) {
        // ensure caller has been granted an allowance from account owner
        require(_value <= allowance[_from][msg.sender]);     

        // adjust the remaining allowance
    ...
    /**
     * Approves `_spender` to send up to `_value` tokens on your behalf
     *
